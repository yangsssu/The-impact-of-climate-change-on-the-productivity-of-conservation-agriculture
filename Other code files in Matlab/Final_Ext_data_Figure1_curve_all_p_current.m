...
title('(a1). barley under CA (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(b1). cotton under CA (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(c1). maize under CA (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(d1). rice under CA (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(e1). sorghum under CA (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(f1). soybean under CA (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(g1). sunflower under CA (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(h1). wheat under CA (+F+WD) practice')
set(gca,'fontsize',12)
%ld=legend('global','tropical','arid','temperate','continental')
...
title('(a2). barley under CA (-F-WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(b2). cotton under CA (-F-WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(c2). maize under CA (-F-WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(d2). rice under CA (-F-WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(e2). sorghum under CA (-F-WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(f2). soybean under CA (-F-WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(g2). sunflower under CA (-F-WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(h2). wheat under CA (-F-WD) practice')
set(gca,'fontsize',12)
%ld=legend('global','tropical','arid','temperate','continental')
%set(ld,'position',[ 0.9091    0.8130    0.0844    0.1030])
%set(ld,'position',[ 0.9151    0.7703    0.0725    0.1392])
...
title('(a3). barley under NT+R-SC (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(b3). cotton under NT+R-SC (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(c3). maize under NT+R-SC (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(d3). rice under NT+R-SC (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(e3). sorghum under NT+R-SC (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(f3). soybean under NT+R-SC (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(g3). sunflower under NT+R-SC (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(h3). wheat under NT+R-SC (+F+WD) practice')
set(gca,'fontsize',12)
%ld=legend('global','tropical','arid','temperate','continental')
%set(ld,'position',[ 0.9091    0.8130    0.0844    0.1030])
%set(ld,'position',[ 0.9151    0.7703    0.0725    0.1392])
...
title('(a4). barley under NT-R-SC (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(b4). cotton under NT-R-SC (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(c4). maize under NT-R-SC (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(d4). rice under NT-R-SC (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(e4). sorghum under NT-R-SC (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(f4). soybean under NT-R-SC (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(g4). sunflower under NT-R-SC (+F+WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(h4). wheat under NT-R-SC (+F+WD) practice')
set(gca,'fontsize',12)
%ld=legend('global','tropical','arid','temperate','continental')
%set(ld,'position',[ 0.9091    0.8130    0.0844    0.1030])
%set(ld,'position',[ 0.9151    0.7703    0.0725    0.1392])
...
title('(a5). barley under NT-R-SC (-F-WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(b5). cotton under NT-R-SC (-F-WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(c5). maize under NT-R-SC (-F-WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(d5). rice under NT-R-SC (-F-WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(e5). sorghum under NT-R-SC (-F-WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(f5). soybean under NT-R-SC (-F-WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(g5). sunflower under NT-R-SC (-F-WD) practice')
%legend('tropical','arid','temperate','continental')
set(gca,'fontsize',12)
...
title('(h5). wheat under NT-R-SC (-F-WD) practice')
set(gca,'fontsize',12)
ld=legend('global','tropical','arid','temperate','continental')
%set(ld,'position',[ 0.9091    0.8130    0.0844    0.1030])
%set(ld,'position',[ 0.9151    0.7703    0.0725    0.1392])
