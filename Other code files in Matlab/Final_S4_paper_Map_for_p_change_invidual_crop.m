...
for m=1:360
    for n=1:720
        if (wheat_mask2(m,n)== 0 || wheat_Ipsl_cm5a_lr_rcp45_PB(m,n) == -99 || wheat_Ipsl_cm5a_lr_rcp45_Tave(m,n) == -99 || wheat_Ipsl_cm5a_lr_rcp45_Tmax(m,n) == -99 || wheat_Ipsl_cm5a_lr_rcp45_Tmin(m,n) == -99 || wheat_Ipsl_cm5a_lr_rcp45_ST_original(m,n)==0 || wheat_Ipsl_cm5a_lr_rcp45_ST_original(m,n) == 13)
            ...
            wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)=wheat_Ipsl_cm5a_lr_rcp45_future_prob_positive(m,n)-wheat_Ipsl_cm5a_lr_rcp45_prob_positive(m,n);
        end
    end
end
wheat_Ipsl_cm5a_lr_rcp45_prob_p1=zeros(360,720);   % 0-0.1 0.1-0.2 0.2-0.3 0.3-0.4 ....
wheat_Ipsl_cm5a_lr_rcp45_prob_p(1,7)=-0.1;wheat_Ipsl_cm5a_lr_rcp45_prob_p(1,8)=-0.075;
wheat_Ipsl_cm5a_lr_rcp45_prob_p(1,9)=-0.05;wheat_Ipsl_cm5a_lr_rcp45_prob_p(1,1)=-0.025;
wheat_Ipsl_cm5a_lr_rcp45_prob_p(1,2)=-0.01;wheat_Ipsl_cm5a_lr_rcp45_prob_p(1,3)=0;wheat_Ipsl_cm5a_lr_rcp45_prob_p(1,4)=0.01;
wheat_Ipsl_cm5a_lr_rcp45_prob_p(1,5)=0.025;wheat_Ipsl_cm5a_lr_rcp45_prob_p(1,6)=0.05;
wheat_Ipsl_cm5a_lr_rcp45_prob_p(1,10)=0.0751;wheat_Ipsl_cm5a_lr_rcp45_prob_p(1,11)=0.075;wheat_Ipsl_cm5a_lr_rcp45_prob_p(1,12)=-11;wheat_Ipsl_cm5a_lr_rcp45_prob_p(1,13)=-10;
for m=1:360
    for n=1:720
        if (wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)>0.1)
            wheat_Ipsl_cm5a_lr_rcp45_prob_p1(m,n)=11+0.5;
        elseif(wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)<=0.1 && wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)>0.075 )
            	wheat_Ipsl_cm5a_lr_rcp45_prob_p1(m,n)=10-0.00001;
        elseif(wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)<=0.075 && wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)>0.05 )
            	wheat_Ipsl_cm5a_lr_rcp45_prob_p1(m,n)=9-0.00001;
        elseif(wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)<=0.05 && wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)>0.025 )
            	wheat_Ipsl_cm5a_lr_rcp45_prob_p1(m,n)=8-0.00001;
        elseif(wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)<=0.025 && wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)>0 )
            	wheat_Ipsl_cm5a_lr_rcp45_prob_p1(m,n)=7-0.00001;
        elseif(wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)<=0 && wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)>-0.025 )
            	wheat_Ipsl_cm5a_lr_rcp45_prob_p1(m,n)=6-0.00001;                            
        elseif(wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)<=-0.025 && wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)>-0.05 )
            	wheat_Ipsl_cm5a_lr_rcp45_prob_p1(m,n)=5-0.00001;
        elseif(wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)<=-0.05 && wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)>-0.075 )
            	wheat_Ipsl_cm5a_lr_rcp45_prob_p1(m,n)=4-0.00001;
        elseif(wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)<=-0.075 && wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)>-0.1 )
            	wheat_Ipsl_cm5a_lr_rcp45_prob_p1(m,n)=3-0.00001;
        elseif(wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)<=-0.1 && wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)>-1)
            	wheat_Ipsl_cm5a_lr_rcp45_prob_p1(m,n)=2-0.00001;
        elseif( wheat_Ipsl_cm5a_lr_rcp45_prob_p(m,n)<=-1 )
...
hcb=colorbar('eastoutside')
set(hcb,'YTick',[1.5,2.4,3.4,4.3,5.2,6.2,7.1,8.1,9,10,11])
set(hcb,'YTickLabel',{'Non-cropping region','<= -0.1','(-0.1,-0.075]','(-0.075,-0.05]','(-0.05,-0.025]','(-0.025,0]','(0,0.025]','(0.025,0.05]','(0.05,0.075]','(0.075,0.1]','>0.1'},'Fontsize',11)  
%
tt=title(hcb,'Change of yield increase prob.');
